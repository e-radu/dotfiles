...
wezterm.on("save_state", function(window, pane) sm.save_state(window, pane) end)
wezterm.on("load_state", function() sm.load_state() end)
wezterm.on("restore_state", function(window) sm.restore_state(window) end)
...
config.background = {
    {
        source = {
            File = "C:/Users/enemr/.config/wezterm/background.png"
        },
        hsb = {
            brightness = 0.15,
            saturation = 1.05,
